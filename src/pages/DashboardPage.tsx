      ...
      <div className="mx-auto max-w-[420px] px-3 pb-28 pt-4">
        <SurfaceCard className="p-4">
          <div className="flex items-start justify-between pb-2">
            <div className="flex min-w-0 items-center gap-3">
              <img src={ztLogo} alt="Nexon logo" className="h-10 w-10 rounded-xl border border-slate-200 bg-white object-contain" />
              <div className="min-w-0">
                <div className="truncate text-lg font-bold leading-tight text-slate-900">Nexon</div>
